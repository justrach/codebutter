...
import { NavigationMenuItem, NavigationMenu, NavigationMenuList, NavigationMenuLink } from "@/components/ui/navigation-menu"
          ...
          <SheetContent side="left">
            ...
            <div className="grid gap-2 py-6">
              <NavigationMenuItem asChild>
                <Link href="#" className="flex w-full items-center py-2 text-xl font-semibold" prefetch={false}>
                  Home
                </Link>
              </NavigationMenuItem>
              <NavigationMenuItem asChild>
